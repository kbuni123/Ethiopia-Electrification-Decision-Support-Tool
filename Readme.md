...
pathways to achieving **100% electrification by 2030**. It combines the World Bank's DRE-ATLAS data, user defined technology cost models, and financing scenarios into an interactive Streamlit application that allows 
